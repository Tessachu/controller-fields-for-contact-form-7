module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            /**
             * Delete build directories & minified files
             */
            build: {
                src: [
        ...
        uglify: {
            ...
            options: {
                ...
                mangle: {
                    ...
                    toplevel: false // Do not mangle names declared in the top level scope
                },
                sourceMap: false // Disable sourcemap creation
            },
            build: {
        ...
        copy: {
            /**
             * Copy Files from Working Directories to Build Directories
             *
             * @see https://www.npmjs.com/package/grunt-contrib-copy
             */
            build: {
                // Copy plugin source files from working folder to build folder
                expand: true, // Enable dynamic expansion
                src: [
                    ...
                    // Exclude WordPress Assets & languages
                    '!**/_wp-assets/**', '!**/languages/**',
            ...
            assets: {
                // Copy WordPress assets from working folder to build folder
                expand: true, // Enable dynamic expansion
                src: [
        ...
        replace: {
            /**
             * Update Version Number & Text Domain
             *
